...
namespace EventFlow.Modules.Attendance.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260706143939_Add_EventStatistics_Table")]
    partial class Add_EventStatistics_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventFlow.Modules.Attendance.Domain.Attendees.Attendee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventFlow.Modules.Attendance.Domain.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventFlow.Modules.Attendance.Domain.Events.EventStatistics", b =>
                {
            ...
            modelBuilder.Entity("EventFlow.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventFlow.Modules.Attendance.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("EventFlow.Modules.Attendance.Domain.Attendees.Attendee", null)
                        .WithMany()
                    ...
                    b.HasOne("EventFlow.Modules.Attendance.Domain.Events.Event", null)
                        .WithMany()
